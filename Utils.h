...
public:
	...
	static void printGui(float fps, float fullFps, const std::string& methodName, int mouseValue, double pParam, const std::string& paletteName);

	static void drawGui(float fps, float fullFps, const std::string& methodName, int mouseValue, double pParam, const std::string& paletteName, uint8_t* img, const P2& imgSize, uint8_t color);
	...
	static void drawGui(float fps, float fullFps, const std::string& methodName, int mouseValue, double pParam, const std::string& paletteName, uint32_t* img, const P2& imgSize, uint32_t rgbaColor);
